...
add_menu_page( 'Virgincareer SMS Gateway settings', 'Virgin SMS', 'manage_options', 'wp10test/wp10settingsgeneral.php', array( $this , 'wp10settingscallback') , 'dashicons-format-chat', 250  );
...
public function wp10customfooter() {
	...
	/**
	 * Saving form data -> Register the menu and sub menu items for the admin area
	 *
	 * @since    1.0.0
	 */
	...
	public function register_wp10_general_settings(){
		...
		register_setting('wp10customsettings','virgin_username');
		register_setting('wp10customsettings','virgin_password');
		register_setting( 'wp10customsettings', 'message_text' );
	}
